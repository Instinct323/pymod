...
def plot_gain(gamma=[2.5, 1.9, 1.6, 1.4], delta=[2, 3, 4, 5], bias=.4,
    ...
    for g, d, c in zip(gamma, delta, colors):
        ...
        gain = (1 - bias) * beta / alpha + bias
        plt.plot(beta, gain, color=c, label=f'α={g}  δ={d}')
...
if __name__ == '__main__':
    ...
    command = [lambda: plot_loss([f.WIoU, f.EIoU], n_points=2000, major_cases=False),
               lambda: simulate_exp(f.WIoU, plot_points=True, major_cases=False),
